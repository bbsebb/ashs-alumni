...
Ce dossier contient tous les diagrammes PlantUML créés pour enrichir l'analyse fonctionnelle de l'application ASHS
Alumni.
...
### 5. Parcours utilisateur (currentUser-journey-flows.puml)
...
Les deux approches sont complémentaires et offrent différents niveaux de détail pour une compréhension complète du
système.
