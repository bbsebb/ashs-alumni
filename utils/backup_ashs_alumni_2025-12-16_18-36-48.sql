...
\restrict HobDoxERTFGXlbuAlfaUotNvl5tATdPnSL3rgvswjkf404vOFCUaYIf9RThLxeU

-- Dumped from database version 17.7
-- Dumped by pg_dump version 17.7

-- Started on 2025-12-16 17:36:48 UTC
...
-- Name: former_teammate_entity; Type: TABLE; Schema: public; Owner: app_prod_user
--

CREATE TABLE public.former_teammate_entity (
    id uuid NOT NULL,
...
ALTER TABLE public.former_teammate_entity OWNER TO app_prod_user;

--
-- TOC entry 221 (class 1259 OID 16405)
-- Name: former_teammate_entity_roles; Type: TABLE; Schema: public; Owner: app_prod_user
--

CREATE TABLE public.former_teammate_entity_roles (
    former_teammate_entity_id uuid NOT NULL,
    roles smallint
);


ALTER TABLE public.former_teammate_entity_roles OWNER TO app_prod_user;

--
-- TOC entry 223 (class 1259 OID 16427)
-- Name: former_teammate_history_entity; Type: TABLE; Schema: public; Owner: app_prod_user
--

CREATE TABLE public.former_teammate_history_entity (
    id uuid NOT NULL,
    former_teammate_id uuid NOT NULL,
    phone_at_time character varying(255),
    email_at_time character varying(255),
...
ALTER TABLE public.former_teammate_history_entity OWNER TO app_prod_user;

--
-- TOC entry 224 (class 1259 OID 16434)
-- Name: former_teammate_history_entity_roles_at_time; Type: TABLE; Schema: public; Owner: app_prod_user
--

CREATE TABLE public.former_teammate_history_entity_roles_at_time (
    former_teammate_history_entity_id uuid NOT NULL,
    roles_at_time smallint
);


ALTER TABLE public.former_teammate_history_entity_roles_at_time OWNER TO app_prod_user;

--
-- TOC entry 226 (class 1259 OID 16465)
-- Name: participant; Type: TABLE; Schema: public; Owner: app_prod_user
--
...
ALTER TABLE public.participant OWNER TO app_prod_user;

--
-- TOC entry 225 (class 1259 OID 16464)
-- Name: participant_seq; Type: SEQUENCE; Schema: public; Owner: app_prod_user
--
...
ALTER SEQUENCE public.participant_seq OWNER TO app_prod_user;

--
-- TOC entry 222 (class 1259 OID 16413)
-- Name: sms_history; Type: TABLE; Schema: public; Owner: app_prod_user
--
...
ALTER TABLE public.sms_history OWNER TO app_prod_user;
...
-- Completed on 2025-12-16 17:36:49 UTC

--
-- PostgreSQL database dump complete
--

\unrestrict HobDoxERTFGXlbuAlfaUotNvl5tATdPnSL3rgvswjkf404vOFCUaYIf9RThLxeU
